...
describe("Testing the Artwork class:", () => {
	...
	const materialRB =	[[ 'Cardboard', 3000, 0.02, 120, 3.50, 'Roll' ]];
	const materialRS =	[[ 'Cardboard', 100, 0.02, 120, 3.50, 'Roll' ]];
	...
	it("Test-14: returns the unit conversion from in to cm.", () => {
		const current =		new ArtWork('001', 70.866, 1.968, 39.370, material).autoConvert;
